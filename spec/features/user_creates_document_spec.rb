feature "Creating Document" do
  # background do
  #   User.make(:email => 'user@example.com', :password => 'caplin')
  # end

  scenario "User navigates to new doc page, inputs valid version info and saves" do
    visit root_url
    click_button 'New Document'

    expect(current_url).to eq 'www.example.com/documents/new'
